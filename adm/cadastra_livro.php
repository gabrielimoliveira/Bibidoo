    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-8 ">
<form method="post" id="cadastralivro" class="livro" enctype="multipart/form-data">
...
<input type="submit" value="CadastrarLivro" name="cadastroLivro" id="botaocadastroL" class="cad" />
                                <div id="entre">
                                    </div>
                        </form>
                </div>
